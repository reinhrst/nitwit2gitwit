...
This is a cheat sheet to go back to, when lost for some steps in git. It summaries all the cheat sheets present in the different lessons (yet to be updated).
